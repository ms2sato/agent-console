...
/**
 * Migration v7: Add sdk_session_id column to workers table.
 * Supports SDK workers that use Claude Code SDK instead of PTY.
 */
async function migrateToV7(database: Kysely<Database>): Promise<void> {
  logger.info('Running migration to v7: Adding sdk_session_id column to workers');
