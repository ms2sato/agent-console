...
import type { Session, Repository, Worktree, AgentActivityState, CreateQuickSessionRequest, CreateRepositoryRequest, CreateWorktreeSessionRequest, WorkerActivityInfo, BranchNameFallback, AgentDefinition, SetupCommandResult, InboundEventSummary } from '@agent-console/shared';
