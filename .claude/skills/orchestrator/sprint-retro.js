...
function getSteps() {
  return [
    ...
    },
    {
      ...
      instructions: [
        'Clean up worktrees for merged PRs. There are TWO populations, and',
        'list_sessions only shows one of them:',
        '',
        ...
        '     3. Run remove_worktree for each',
        '',
        ...
        '',
        'Two traps when deciding whether a branch is merged — both hit in Sprint',
        '2026-08-28, and either one alone would have produced a wrong answer:',
        '',
        ...
        '    main. Use the PR state, not ancestry.',
        ...
        '    work, so settle it on content before deleting.',
        '',
