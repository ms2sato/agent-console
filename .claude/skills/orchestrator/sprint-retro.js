  ...
  return [
    ...
    },
    {
      ...
      instructions: [
        ...
        '     single writer is this script\'s own parser, `.split(/[\\s,]+/)`) — an',
        '     unquoted `printf` alone does not split on commas, so normalize both',
        '     separators to newlines before sorting:',
        '       printf \'%s\\n\' $SPRINT_PR_NUMBERS <retro-pr-number> | tr \', \' \'\\n\' | sed \'/^$/d\' | sort -n > /tmp/known.txt',
        '  4. Diff the two:',
