...
export const KNOWN_VIOLATIONS = new Set([
  ...
  'packages/server/src/lib/git.ts:46:35:issue-ref',
  'packages/server/src/lib/git.ts:310:42:issue-ref',
  'packages/server/src/lib/git.ts:393:22:issue-ref',
  ...
  'packages/server/src/services/session-manager.ts:971:209:issue-ref',
  ...
  'packages/server/src/services/worktree-service.ts:95:32:issue-ref',
  'packages/server/src/services/worktree-service.ts:108:63:issue-ref',
  'packages/server/src/services/worktree-service.ts:158:5:issue-ref',
  'packages/server/src/services/worktree-service.ts:189:41:issue-ref',
  'packages/server/src/services/worktree-service.ts:298:7:issue-ref',
  'packages/server/src/services/worktree-service.ts:463:22:issue-ref',
  'packages/server/src/services/worktree-service.ts:536:64:issue-ref',
  'packages/server/src/services/worktree-service.ts:625:24:issue-ref',
  'packages/server/src/services/worktree-service.ts:678:54:issue-ref',
  'packages/server/src/services/worktree-service.ts:736:7:issue-ref',
  'packages/server/src/services/worktree-service.ts:736:52:issue-ref',
  'packages/server/src/services/worktree-service.ts:736:65:pr-ref',
  'packages/server/src/services/worktree-service.ts:914:26:issue-ref',
  'packages/server/src/services/worktree-service.ts:954:45:issue-ref',
  'packages/server/src/services/worktree-service.ts:1063:27:issue-ref',
  'packages/server/src/services/worktree-service.ts:1109:25:issue-ref',
