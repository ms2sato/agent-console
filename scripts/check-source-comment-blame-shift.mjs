...
export const KNOWN_VIOLATIONS = new Set([
  ...
  'packages/server/src/database/connection.ts:1290:45:issue-ref',
  'packages/server/src/database/connection.ts:1300:48:issue-ref',
  ...
  'packages/server/src/services/worker-manager.ts:127:6:issue-ref',
  'packages/server/src/services/worker-manager.ts:152:53:issue-ref',
  'packages/server/src/services/worker-manager.ts:355:15:issue-ref',
  'packages/server/src/services/worker-manager.ts:397:8:issue-ref',
  'packages/server/src/services/worker-manager.ts:591:8:issue-ref',
