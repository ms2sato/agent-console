...
export const KNOWN_VIOLATIONS = new Set([
  ...
  'packages/server/src/services/session-manager.ts:553:76:issue-ref',
  'packages/server/src/services/session-manager.ts:961:209:issue-ref',
  ...
  'packages/server/src/websocket/routes.ts:801:16:issue-ref',
  'packages/server/src/websocket/routes.ts:801:52:pr-ref',
