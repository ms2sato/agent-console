...
export const KNOWN_VIOLATIONS = new Set([
  ...
  'packages/server/src/mcp/mcp-server.ts:514:59:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:750:12:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:750:25:pr-ref',
  'packages/server/src/mcp/mcp-server.ts:755:38:pr-ref',
  'packages/server/src/mcp/mcp-server.ts:795:14:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:795:34:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:795:47:pr-ref',
  'packages/server/src/mcp/mcp-server.ts:860:15:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:1006:25:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:1007:43:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:1012:45:pr-ref',
  'packages/server/src/mcp/mcp-server.ts:1213:37:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:1218:42:pr-ref',
  'packages/server/src/mcp/mcp-server.ts:1362:32:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:1368:13:pr-ref',
  ...
  'packages/server/src/websocket/routes.ts:789:16:issue-ref',
  'packages/server/src/websocket/routes.ts:789:52:pr-ref',
