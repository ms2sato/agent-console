...
export const KNOWN_VIOLATIONS = new Set([
  ...
  'packages/server/src/services/session-manager.ts:533:76:issue-ref',
  'packages/server/src/services/session-manager.ts:934:209:issue-ref',
  ...
  'packages/server/src/websocket/routes.ts:743:16:issue-ref',
  'packages/server/src/websocket/routes.ts:743:52:pr-ref',
