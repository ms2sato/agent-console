...
export const KNOWN_VIOLATIONS = new Set([
  ...
  'packages/server/src/mcp/mcp-server.ts:205:7:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:205:58:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:205:71:pr-ref',
  'packages/server/src/mcp/mcp-server.ts:210:33:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:219:33:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:521:59:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:785:12:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:785:25:pr-ref',
  'packages/server/src/mcp/mcp-server.ts:790:38:pr-ref',
  'packages/server/src/mcp/mcp-server.ts:830:14:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:830:34:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:830:47:pr-ref',
  'packages/server/src/mcp/mcp-server.ts:896:15:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:1051:25:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:1052:43:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:1057:45:pr-ref',
  'packages/server/src/mcp/mcp-server.ts:1258:37:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:1263:42:pr-ref',
  'packages/server/src/mcp/mcp-server.ts:1407:32:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:1413:13:pr-ref',
  ...
  'packages/server/src/routes/workers.ts:355:8:issue-ref',
  'packages/server/src/routes/workers.ts:355:44:pr-ref',
  'packages/server/src/routes/workers.ts:396:8:issue-ref',
  'packages/server/src/routes/workers.ts:396:44:pr-ref',
  'packages/server/src/routes/workers.ts:415:42:issue-ref',
