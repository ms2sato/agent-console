...
export const KNOWN_VIOLATIONS = new Set([
  ...
  'packages/server/src/database/connection.ts:1286:45:issue-ref',
  'packages/server/src/database/connection.ts:1296:48:issue-ref',
  ...
  'packages/server/src/services/session-manager.ts:547:76:issue-ref',
  'packages/server/src/services/session-manager.ts:948:209:issue-ref',
  ...
  'packages/server/src/services/worker-lifecycle-manager.ts:231:10:issue-ref',
  'packages/server/src/services/worker-lifecycle-manager.ts:554:31:issue-ref',
  'packages/server/src/services/worker-manager.ts:118:6:issue-ref',
  'packages/server/src/services/worker-manager.ts:143:53:issue-ref',
  'packages/server/src/services/worker-manager.ts:345:15:issue-ref',
  'packages/server/src/services/worker-manager.ts:387:8:issue-ref',
  'packages/server/src/services/worker-manager.ts:581:8:issue-ref',
