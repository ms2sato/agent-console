...
export const KNOWN_VIOLATIONS = new Set([
  ...
  'packages/server/src/services/worktree-service.ts:440:22:issue-ref',
  'packages/server/src/services/worktree-service.ts:513:64:issue-ref',
  'packages/server/src/services/worktree-service.ts:602:24:issue-ref',
  'packages/server/src/services/worktree-service.ts:655:54:issue-ref',
  'packages/server/src/services/worktree-service.ts:713:7:issue-ref',
  'packages/server/src/services/worktree-service.ts:713:52:issue-ref',
  'packages/server/src/services/worktree-service.ts:713:65:pr-ref',
  'packages/server/src/services/worktree-service.ts:891:26:issue-ref',
  'packages/server/src/services/worktree-service.ts:931:45:issue-ref',
  'packages/server/src/services/worktree-service.ts:1040:27:issue-ref',
  'packages/server/src/services/worktree-service.ts:1086:25:issue-ref',
