...
export const KNOWN_VIOLATIONS = new Set([
  ...
  'packages/server/src/mcp/mcp-server.ts:1010:25:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:1011:43:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:1016:45:pr-ref',
  'packages/server/src/mcp/mcp-server.ts:1217:37:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:1222:42:pr-ref',
  'packages/server/src/mcp/mcp-server.ts:1366:32:issue-ref',
  'packages/server/src/mcp/mcp-server.ts:1372:13:pr-ref',
