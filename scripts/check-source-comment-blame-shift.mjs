...
export const KNOWN_VIOLATIONS = new Set([
  ...
  'packages/server/src/lib/server-config.ts:122:44:issue-ref',
  ...
  'packages/server/src/services/worktree-service.ts:73:32:issue-ref',
  'packages/server/src/services/worktree-service.ts:86:63:issue-ref',
  'packages/server/src/services/worktree-service.ts:136:5:issue-ref',
  'packages/server/src/services/worktree-service.ts:167:41:issue-ref',
  'packages/server/src/services/worktree-service.ts:276:7:issue-ref',
  'packages/server/src/services/worktree-service.ts:424:22:issue-ref',
  'packages/server/src/services/worktree-service.ts:497:64:issue-ref',
  'packages/server/src/services/worktree-service.ts:586:24:issue-ref',
  'packages/server/src/services/worktree-service.ts:639:54:issue-ref',
  'packages/server/src/services/worktree-service.ts:697:7:issue-ref',
  'packages/server/src/services/worktree-service.ts:697:52:issue-ref',
  'packages/server/src/services/worktree-service.ts:697:65:pr-ref',
  'packages/server/src/services/worktree-service.ts:875:26:issue-ref',
  'packages/server/src/services/worktree-service.ts:915:45:issue-ref',
  'packages/server/src/services/worktree-service.ts:1024:27:issue-ref',
  'packages/server/src/services/worktree-service.ts:1070:25:issue-ref',
  ...
  'packages/server/src/websocket/routes.ts:713:16:issue-ref',
  'packages/server/src/websocket/routes.ts:713:52:pr-ref',
