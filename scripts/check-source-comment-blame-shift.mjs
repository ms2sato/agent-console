...
export const KNOWN_VIOLATIONS = new Set([
  ...
  'packages/server/src/database/connection.ts:1278:45:issue-ref',
  'packages/server/src/database/connection.ts:1288:48:issue-ref',
  ...
  'packages/server/src/services/worker-lifecycle-manager.ts:495:31:issue-ref',
  ...
  'packages/server/src/websocket/routes.ts:725:16:issue-ref',
  'packages/server/src/websocket/routes.ts:725:52:pr-ref',
