...
- **Contrast:** the [Initial Prompt](#initial-prompt-session--initialprompt-initialpromptdelivered) delivery is explicitly NOT a notification (it is the conversation's substance, user-authored by proxy) and carries no `notification` field.
